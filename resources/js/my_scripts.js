...
function switchPlayers(playerNum)
{
	...
	document.getElementById("player_img").scr = players[playerNum].img; //this and alt are not working 
	...
	var num = 0;
	if(players[playerNum].year == "Freshman")
	{
		num = 1;
	}
	...
	document.getElementById("avg_p_yards").innerHTML = (players[playerNum].pass_yards / num);
	document.getElementById("avg_r_yards").innerHTML = (players[playerNum].rushing_yards / num);
	document.getElementById("avg_rec_yards").innerHTML = (players[playerNum].receiving_yards / num);
}
